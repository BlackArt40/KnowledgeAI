...
const nextConfig: NextConfig = {
  ...
  serverExternalPackages: ["@prisma/client", "bullmq", "ioredis", "@aws-sdk/client-s3", "@aws-sdk/s3-request-presigner", "pdf-parse", "mammoth", "xlsx", "tesseract.js", "pdfjs-dist", "@napi-rs/canvas", "qrcode", "pino"],
  // 生产安全响应头
  async headers() {
    return [
      {
