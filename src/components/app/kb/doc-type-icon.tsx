import { FileText, FileType2, FileCode, Link2, FileSpreadsheet, FileImage, File, Captions } from "lucide-react";
...
const map: Record<DocType, { icon: React.ComponentType<{ className?: string }>; cls: string }> = {
  ...
  subtitle: { icon: Captions, cls: "bg-teal-500/12 text-teal-500" },
